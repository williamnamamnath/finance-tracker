      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100">
          <div className="px-5 py-4 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center gap-3">
            <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide shrink-0">Recent Expenses</h2>
          ...
          {filteredTransactions.length === 0 ? (
            <p className="text-gray-400 text-sm text-center py-10">{transactions.length === 0 ? "No expenses recorded yet." : "No expenses match your search."}</p>
          ) : (
                  ...
                  {confirmDeleteId === t.id ? (
                    ...
                    <div className="flex justify-between items-center gap-3">
                      <div className="flex items-center gap-3 min-w-0">
                        <span className="inline-block px-2 py-0.5 rounded-full text-xs font-semibold flex-shrink-0 bg-red-100 text-red-600">Expense</span>
                      ...
                      <div className="flex items-center gap-4 flex-shrink-0">
                        <span className="font-bold text-base text-red-500 tabular-nums">-${Number(t.amount).toFixed(2)}</span>
